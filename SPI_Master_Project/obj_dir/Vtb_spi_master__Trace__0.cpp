...
void Vtb_spi_master___024root__trace_chg_0_sub_0(Vtb_spi_master___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vtb_spi_master___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_spi_master___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vtb_spi_master___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vtb_spi_master___024root__trace_chg_0_sub_0(Vtb_spi_master___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_spi_master__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_spi_master___024root__trace_chg_0_sub_0\n"); );
...
void Vtb_spi_master___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_spi_master___024root__trace_cleanup\n"); );
    // Init
    Vtb_spi_master___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vtb_spi_master___024root*>(voidSelf);
    Vtb_spi_master__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
