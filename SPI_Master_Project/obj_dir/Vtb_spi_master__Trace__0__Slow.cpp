...
VL_ATTR_COLD void Vtb_spi_master___024root__trace_init_sub__TOP__0(Vtb_spi_master___024root* vlSelf, VerilatedVcd* tracep) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_spi_master__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_spi_master___024root__trace_init_sub__TOP__0\n"); );
...
VL_ATTR_COLD void Vtb_spi_master___024root__trace_init_top(Vtb_spi_master___024root* vlSelf, VerilatedVcd* tracep) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_spi_master__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_spi_master___024root__trace_init_top\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    Vtb_spi_master___024root__trace_init_sub__TOP__0(vlSelf, tracep);
}

VL_ATTR_COLD void Vtb_spi_master___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
VL_ATTR_COLD void Vtb_spi_master___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void Vtb_spi_master___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
void Vtb_spi_master___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/);

VL_ATTR_COLD void Vtb_spi_master___024root__trace_register(Vtb_spi_master___024root* vlSelf, VerilatedVcd* tracep) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_spi_master__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_spi_master___024root__trace_register\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    tracep->addConstCb(&Vtb_spi_master___024root__trace_const_0, 0U, vlSelf);
    tracep->addFullCb(&Vtb_spi_master___024root__trace_full_0, 0U, vlSelf);
    tracep->addChgCb(&Vtb_spi_master___024root__trace_chg_0, 0U, vlSelf);
    tracep->addCleanupCb(&Vtb_spi_master___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void Vtb_spi_master___024root__trace_const_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_spi_master___024root__trace_const_0\n"); );
    // Init
    Vtb_spi_master___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vtb_spi_master___024root*>(voidSelf);
    Vtb_spi_master__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
}

VL_ATTR_COLD void Vtb_spi_master___024root__trace_full_0_sub_0(Vtb_spi_master___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void Vtb_spi_master___024root__trace_full_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_spi_master___024root__trace_full_0\n"); );
    // Init
    Vtb_spi_master___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vtb_spi_master___024root*>(voidSelf);
    Vtb_spi_master__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    Vtb_spi_master___024root__trace_full_0_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void Vtb_spi_master___024root__trace_full_0_sub_0(Vtb_spi_master___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtb_spi_master__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_spi_master___024root__trace_full_0_sub_0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
